...
class BladeOutput:
    ...
    def make_stl(self):
        ...
        print("Writing STL mesh generation files...", end='               ')
        ...
        for v_section in v:
            ...
            for i in range(n_points):
                mesh_points.append( [section_coordinates[2, i],           # SU2 x coordinate (radial)
                                  section_coordinates[1, i],            # SU2 y coordinate (tangential)
                                  section_coordinates[0, i]])
            index = index+1
        ...
        o3d.io.write_triangle_mesh(self.full_path+"blade.stl", bpa_mesh)
    ...
    def make_TurboGrid_meshfile(self):
        ...
        print (self.full_path + "blade.crv")
